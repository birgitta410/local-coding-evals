...
@scripts/visualise_access_logs.mjs"`,
  ...
  expectation: `
- There is code to implement a horizontal bar chart showing the number of requests per country
- in WORKING_DIR: Run "node scripts/visualise_access_logs.mjs server/weblogs/extracts" to generate the timeline.html file
